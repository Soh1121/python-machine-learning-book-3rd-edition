...
# Wineデータセットを用いるため、pandasをpdとしてインポート
import pandas as pd
# バギング分類器を用いるために、sklearnのensembleから、BaggingClassifierをインポートする
from sklearn.ensemble import BaggingClassifier
# 性能を算出するため、sklearnのmetricsから、accuracy_scoreメソッドをインポート
...
le = LabelEncoder()
y = le.fit_transform(y)
# データセットを80%の訓練データセットと20%のテストデータセットに分ける
